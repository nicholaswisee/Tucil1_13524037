...
public class Solver {
  ...
  public static Solution solve(Board board) {
    ...
    // No solution found
    long elapsedTime = System.currentTimeMillis() - startTime;
    SolutionStats stats = new SolutionStats(elapsedTime, cases, false);
    return null; // Or Solution with null positions
  }


  private static boolean isValidSolution(List<Position> queenPositions, Board board) {
  ...
  private static boolean hasAttacks(List<Position> queenPositions) {
  ...
  private static boolean hasOnePerRegion(List<Position> queenPositions, Board board) {
